window._bd_share_main.F.module('trans/logger', function (e, t) {
  ...
  var r = e('component/comm_tools')
  var i = e('conf/const').URLS
  var s = /([http|https]:\/\/[a-zA-Z0-9\_\.]+\.baidu\.com)/ig
  var o = /[#|&](\d+\-[a-zA-Z\d]+\-\d+\-\d+\-[a-f\d]{32}$)/g
  var u = (r.getPageUrl().match(o) || '').toString().replace(/#|&/g, '')
  var a = function (e, t) {
  ...
  var f = function (e) {
    ...
    var l = i.nsClick + '?' + n.ajax.param(f)
    n.sio(l).log()
  ...
  var l = function () {
    ...
    var t = i.nsClick + '?' + n.ajax.param(e)
    n.sio(t).log()
  }
  var c = function () {
    if (u != '') {
      ...
      var t = i.backUrl + '?' + n.ajax.param(e)
      n.sio(t).log()
    }
  }
  var h = function () {
