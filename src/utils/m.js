!(function (n) {
  ...
  r.m = n, r.c = e, r.d = function (t, i, n) {
    ...
    if (r.r(n), Object.defineProperty(n, 'default', {
      enumerable: !0,
      value: i
    }), 2 & t && 'string' !== typeof i) {for (var e in i) r.d(n, e, function(t) {
      return i[t]
    }.bind(null, e))}
    return n
  }, r.n = function (t) {
  ...
  t.exports = {
    ...
    h: function (t) {
      ...
      return t == null ? 'null' : i[Object.prototype.toString.call(t)] || 'object'
    },
    f: function (t) {
    ...
    D: function (t) {
      var i; var n = Object.prototype.hasOwnProperty
    ...
    x: function (t) {
      ...
      } else if (this.D(t)) for (i in e = {}, t) t.hasOwnProperty(i) && (e[i] = this.x(t[i]))
      return e
    },
    C: function (t, i) {
      var n = Array.prototype.slice.apply(arguments);
        var e = n.shift();
        var r = 'function' === typeof this ? this : n.shift()
      return function () {
  ...
  t.exports = {
    g: function (t, i) {
      return t ? 'string' === r.h(t) && t.length > 0 ? (i = i || window).document.getElementById(t) : !t.nodeName || t.nodeType !== 1 && t.nodeType !== 9 ? null : t : null
    },
    U: function (t) {
    ...
    B: function (t, i) {
      i = arguments.length === 2 ? i : t.parent
    ...
    M: function (t, i, s) {
      ...
      var n = r.C(this, function () {
          ...
          else if (this.domReadyMonitorRunTimes > 3e5) return void (this.domReadyMonitorId && (s.clearInterval(this.domReadyMonitorId), this.domReadyMonitorId = null))
          if (t) {try {
            if (this.readyFuncArray && this.readyFuncArray.length) for (var n = 0, e = this.readyFuncArray.length; n < e; n++) {
    ...
    j: function (t, i) {
      arguments.length === 1 && 'number' === r.h(t) && (i = t, t = undefined), i = i || 10
    ...
    z: function (t, i, n) {
      try {
        ...
        var e = o && o.stack ? o.stack : o;
          var r = '//eclick.baidu.com/se.jpg?type=fatalError&key=loadScriptError&mes=' + encodeURIComponent(e) + '&version=newDup&rdm=' + Math.random();
        (new Image()).src = r
      }
    }
  }
  ...
  l.slotTotalCount = l.slotTotalCount || 1, l.slotCountIndex = l.slotCountIndex || {}, t.exports = {
    ...
    Ut: function (t) {
      for (var i in d) if (d.hasOwnProperty(i) && i.indexOf(t) > -1) return d[i]
      return {}
    },
    Pt: function (t) {
      var i = '' + t.slotId
      ...
      var n = {}
      return n.index = l.slotCountIndex[i], n.count = i.indexOf("u") === 0 ? l.slotTotalCount : 0, n.id = i + '_' + n.index, n.containerId = u.V + '_wrapper_' + i + '_' + n.index, n.slotId = t.slotId, n.productLine = t.productLine, n.errors = [], l.slotCountIndex[i] = l.slotCountIndex[i] + 1, i !== u.gt && (l.slotTotalCount = l.slotTotalCount + 1), n.isAsync = t.isAsync, n.timestampWatcher = f.startTime ? {
        t1: f.startTime
      } : {
        t1: 0
      }, t.coa && 'object' === typeof t.coa ? n.styleOpenApi = t.coa : window.cproStyleApi ? n.styleOpenApi = window.cproStyleApi[i] || {} : n.styleOpenApi = {}, n.isUnion = i.indexOf("u") === 0, n.width = 0, n.height = 0, n
    },
    processSlot: function (t) {
      var i = t.response.rtb_deliv;
        var n = t.response.order_deliv;
        var e = t.response.pdb_deliv;
        var r = i.deliv_id = parseInt(i.deliv_id, 10);
        var o = i.demand_id = parseInt(i.demand_id, 10);
        var a = n.deliv_id = parseInt(n.deliv_id, 10);
        var s = n.demand_id = parseInt(n.demand_id, 10);
        var c = e.deliv_id = parseInt(e.deliv_id, 10)
      e.demand_id = parseInt(e.demand_id, 10)
      var u = t.response.placement || {}
      t.containerInfo = u.container || {}, t.complementType = u.complement_type, t.isPdbAd = !(r || o || a || s), t.isNeedCacheRequest = r !== 0 && t.complementType === 7 || a !== 0 || r !== 0 && c !== 0
    },
    Tt: function (t, i) {
      var n = '115313'
      n.length > 6 && (n = ''), i && n && (t.exps = e.Ot(t.exps, n)), d[t.id] = t
    },
    Et: function (t, i) {
      t.status = t.status ^ i
    },
    ...
    Ft: function (t) {
      ...
      var i; var n = t.isUnion || t.isAsync
      t.paramObj = o.Nt(t)
    ...
    jt: function (t) {
      ...
      i && i.tuid && (i.placement && i.placement.update && i.queryid ? (this.Vt(i), i.tuid.indexOf("u") > -1 && i.noadx && parseInt(i.noadx, 10) && parseInt(i.noadx, 10) !== 3 && this.qt(i), i.placement.basic && i.placement.basic.flowType === 2 && r.Jt(i.queryid)) : i.type === 1 && this.Gt(t, i))
    },
    Gt: function (t, i) {
      var n = t.origin || t.originalEvent.origin;
        ...
        var a = this.Ut(r);
        var s = a && a.response;
        var c = s && s.placement && s.placement.basic && s.placement.basic.publisherDomain && s.placement.basic.publisherDomain.pos
      !a || e !== u.$ && e !== c || 'click' !== o || this.Xt(a)
    },
    Vt: function (t) {
      var i; var n = t.placement.update;
        var e = h.Kt(t.tuid)
    ...
    ii: function (t) {
      var i = t.response;
        ...
        var e = i.rtb_deliv;
        var r = i.order_deliv
      return !(!t.isUnion && t.complementType === 7 && n.deliv_id === 0 && e.deliv_id === 0 && r.deliv_id === 0)
    },
    qt: function (t) {
      var i = this.Ut(t.tuid)
      i && i.complementType === 7 && this.Xt(i)
    },
    Xt: function (t) {
    ...
    processSlotInfo: function (t) {
      var i = this.ni(t);
        var n = t.response.placement.basic
      return i.cname = n.cname, i
    },
    ni: function (t) {
      var i = t.response.placement;
        var n = t.response["extends"] || {};
        var e = _.g(t.containerId);
        var r = i.container;
        var o = t.styleOpenApi;
        var a = r.width;
        var s = r.height;
        var c = o.cpro_w || o.rsi0 || 0;
        var u = o.cpro_h || o.rsi1 || 0;
        var h = r.sizeType
      if (h !== 5 && !t.isUnion && n && n.hasOwnProperty('sspw') && n.hasOwnProperty('ssph')) {
        var f = parseInt(n.sspw || 0, 10);
          var d = parseInt(n.ssph || 0, 10);
          var l = parseInt(n.cbsz || 0, 10)
        h = l > 0 ? l : h, a = f > 0 ? f : a, s = d > 0 ? d : s
      }
      if (o.scale) {
        h = 2
        var v = o.scale.split('.') || []
        a = v[0], s = v[1]
      }(c || u) && (h = 1, a = c || w.ei(), s = u || s), ('-1' === t.pcwd || t.ftpc || t.styleOpenApi.cpro_ftpc) && (h = '-1' === t.pcwd && '-1' === t.pchd ? 8 : 5), o.sizeType && (h = o.sizeType && parseInt(o.sizeType, 10) || h, a = o.width && parseInt(o.width, 10) || a, s = o.height && parseInt(o.height, 10) || s), o.apType !== 2 && o.apType !== 3 || (r.location = o.apType)
      var p = 0
      switch (h) {
        case 1:
          break
  ...
  var e = {
    ai: function () {
      ...
      for (var n = ['Android', 'iPad', 'iPod', 'iPhone', 'iOS', 'Linux', 'Macintosh', 'Windows'], e = '', r = 0; r < n.length; r++) {if (e = n[r], t.match(new RegExp(e, "i"))) {
    ...
    si: function () {
      ...
      try {
        ...
        if (t === 0 && (c.ActiveXObject || c.hasOwnProperty('ActiveXObject'))) {for (var e = 30; 2 <= e; e--) try {
  ...
  var c = n(0);
    ...
    var u = {};
    var r = e.j();
    var h = r.BAIDU_SSP__info || (r.BAIDU_SSP__info = {})
  t.exports = {
    ci: function (t, i, n) {
      var e; var r = n ? h : u
      if ('string' === c.h(t)) {
  ...
  t.exports = {
    ...
    wi: function (t) {
      ...
      if (e && t.getBoundingClientRect) {
        ...
        var a = this.mi(e, 'borderLeftWidth');
          var s = this.mi(e, "borderTopWidth");
          var c = parseInt(a, 10);
          var u = parseInt(s, 10)
    ...
    mi: function (t, i) {
      if (!t) return ''
      var n = ''
      n = i.indexOf("-") > -1 ? i.replace(/[-][^-]{1}/g, function (t) {
    ...
    Ei: function (t) {
      return 'none' !== this.Oi(t, 'display') && 'hidden' !== this.Oi(t, 'visibility') && this.bi(t) === 100
    },
    Ri: function (t, i) {
    ...
    ri: function (t) {
      var i = parseInt(this.mi(t, 'paddingLeft'), 10) || 0;
        var n = parseInt(this.mi(t, "paddingRight"), 10) || 0;
        var e = t.clientWidth - i - n
      return e = e > 0 ? e : window.screen.width
    },
    oi: function (t) {
      var i = parseInt(this.mi(t, 'paddingTop'), 10) || 0;
        var n = parseInt(this.mi(t, "paddingBottom"), 10) || 0;
        var e = t.clientHeight - i - n
      return e = e > 0 ? e : 0
    }
  }
}, function (t, i, n) {
  ...
  t.exports = {
    Qt: function (t) {
      var i; var n = t.id ? t.id : "";
        var e = t.async ? t.async : "";
        var r = t.type ? t.type : "ssplog";
        var o = t.pos ? t.pos : "";
        var a = t.status ? t.status : "";
        var s = t.mes ? encodeURIComponent(t.mes) : "";
        var c = t.exps ? t.exps : ''
  ...
  var o = n(2);
    ...
    var s = n(13);
    var c = n(17);
    var u = 'BAIDU_DUP_log_storage'
  t.exports = {
    ji: function (t, i) {
      var n = new Image();
        var e = 'BAIDU_DUP_log_' + Math.floor(2147483648 * Math.random()).toString(36);
    ...
    Li: function (t) {
      ...
      (window[n] = i).onload = i.onerror = i.onabort = function () {
        ...
        i = null
      }, t += t.indexOf("?") > -1 ? '&' : '?', t += 'stamp=' + Math.random(), i.src = t
    },
    Fi: function (t) {
      var i = (t = 'object' === a.h(t) ? t : {}).url || o.nt;
        ...
        var e = t.option || "now";
        var r = a.u(n)
      switch (i += (i.indexOf("?") >= 0 ? '&' : '?') + r + (r ? '&' : '') + 'rdm=' + +new Date(), e) {
        case 'now':
          this.ji(i)
          break
        case 'block':
  ...
  t.exports = {
    ...
    regisetViewWatch: function (t) {
      ...
      if (i) {
        ...
        if (window.postMessage && u.slotId && u.slotId.indexOf("u") > -1) {
    ...
    unregisetViewWatch: function (t) {
      if (this.Xi) {for (var i = t.containerId, n = 0; n < this.Xi.length; n++) {
    ...
    Qi: function () {
      this.nn(), _.M(r.C(this, this.en), 2e3), s.platform && (s.platform.indexOf("Android") > -1 || s.platform.indexOf("Phone") > -1 || s.platform.indexOf("iPod") > -1) || _.L(g, 'beforeunload', r.C(this, this.rn))
    },
    Zi: function (t, i) {
      var n = w.gi(i)
      ...
      e > 1e4 && (e = 0), r > 1e4 && (r = 0), t.desktopResolution = e + ',' + r, t.browserRegion = w.pi(window) + ',' + w._i(window), t.pageRegion = w.Ii(window) + ',' + w.Si(window)
    },
    on: function (t, i) {
      var n; var e; var r; var o = i.isInView;
        var a = i.isAdView;
        var s = new Date()
    ...
    sn: function (t) {
      return !!t && (w.bi(t) >= 50 && w.Mi(t))
    },
    bi: function (t) {
      var i = t.domId
      this.Gi[i] = this.Gi[i] || 0
      var n = w.bi(i)
      return n === 100 && (this.Gi[i] |= 1), n < 100 && n > 0 && (this.Gi[i] |= 2), n === 0 && (this.Gi[i] |= 4), this.Gi[i]
    },
    gi: function (t) {
      var i = w.wi(t);
        var n = w.ki(window);
    ...
    cn: function () {
      if (this.Xi) {for (i = 0, count = this.Xi.length; i < count; i++) {
        var t = this.Xi[i],
          n = this.an(t)
    ...
    nn: function (t) {
      l = u, this.hn(g), (!s.ie || s.ie && s.ie > 6) && this.un(), this.Ki = setInterval(r.C(this, this.un), this.Yi)
    },
    en: function (t) {
      var i, n, e, r, o
    ...
    rn: function (t) {
      try {
        ...
        for (var i = 0, n = this.Xi.length; i < n; i++) {
          var e = this.Xi[i]
          e && e.analysisUrl && !e.isSended && (e.isSended = !0, i === 0 && (e.analysisUrl += '&total=' + this.Xi.length), c.Fi({
            url: e.analysisUrl
          }))
        }
        if (t) {
          var r; var o = (new Date()).getTime()
          if (s.ie) for (r = o + 200; o < r;) o = (new Date()).getTime()
          else {
            for (n = 1e5, i = 0; i < n; i++);
            n = (n = 2e7 / ((r = (new Date).getTime()) - o)) > 1e7 ? 1e7 : n
            for (i = 0; i < n; i++);
          }
        }
      } catch (a) {}
  ...
  t.exports = {
    ...
    yn: function () {
      var t = navigator.userAgent;
        var i = !(!t || !t.match(/iphone.*micromessenger/i))
    ...
    renderRichMaterial: function (t) {
      var i = t.response;
        var n = i && i.pdb_deliv && i.pdb_deliv.deliv_des;
        var e = n && n._html;
        var r = t.isNeedCacheRequest
      ...
      var o = l.g(t.containerId);
        ...
        var c = t.productLine;
        var u = !1
      if (s) {if (!s || "clb" !== c && "dup" !== c) u = this.pn(o, a)
      else {
        var h = this.bn(t)
        o.innerHTML = h, u = !0
    ...
    In: function (t) {
      var i; var n = t.containerInfo;
        var e = t.width || n.width;
        var r = t.height || n.height;
        var o = this.wn();
        var a = "iframe" + t.id;
        var s = f.V + 'renderFrame_'
  ...
  t.exports = {
    ...
    Ht: function (t) {
      var i = []
      for (var n in t) {if (n && (t[n] || 0 === t[n]) && t.hasOwnProperty(n)) {
        var e = t[n]
        i.push(n + "=" + e)
      }}
    ...
    getPmpRequestUrl: function (t) {
      ...
      var c = s.pdb_deliv;
        var u = s.order_deliv;
        var h = s.rtb_deliv
      s.media_protect && '0' !== s.media_protect && i.push('mpdi=' + s.media_protect), c.deliv_id && i.push('pdbid=' + c.deliv_id), u.deliv_id && i.push('orderid=' + u.deliv_id), u.demand_id && i.push('odid=' + u.demand_id), h.deliv_id && i.push('rtbid=' + h.deliv_id), h.demand_id && i.push('rdid=' + h.demand_id), t.isNeedCacheRequest && (n.dpv = n.qn), t.isUnion ? i.push('dc=3') : i.push('dc=2'), r > 0 && (n.tt = r + '.' + (o - r) + '.' + (a - r) + '.' + (+new Date() - r)), n.exps && (i.push('exps=' + n.exps), n.exps = '')
      var f = i.join('&')
      return d.Y + f + '&' + this.Ht(n)
    },
    Dn: function (t, i) {
      var n = o[t] && o[t].paramsList
      if (n) for (var e = 0; e < n.length; e++) if (n[e].key === i) return r.C(o[t], n[e].value)()
    }
  }
}, function (t, i, n) {
  var o = n(1)
  t.exports = {
    L: function (t, i, n) {
      var e = o.T(t) ? t : o.g(t)
      if (e) {if (e.addEventListener) e.addEventListener(i, n, !1)
    ...
    xn: function (t, i, n) {
      ...
      else if (r) for (e = r.length - 1; e >= 0; e--) r[e].handler === n && r.splice(e, 1)
      return t
    },
    F: function (t, i, n) {
  ...
  t.exports = {
    ...
    In: function (t) {
      var i = t.containerInfo;
        ...
        var e = t.height || i.height;
        var r = l.getPmpRequestUrl(t);
        var o = ''
      ...
      } else if (t.styleOpenApi && t.styleOpenApi.floatingState && 'show' !== t.styleOpenApi.floatingState || i.location === 2) {
  ...
  t.exports = {
    ...
    Fn: function (t) {
      ...
      var i; var n = [];
        var e = f.hi(this.Rn) || f.hi(this.En) || {}
      if ('object' === h.h(e)) for (var r in e) h.e.call(e, r) && (i = r + '=' + e[r].join(','), n[n.length] = i)
  ...
  t.exports = {
    paramsList: [{
      ...
      value: function () {
        var t
        return (t = u.location && u.location.href ? u.location.href : s.zn(function(t) {
          var i = a.pi(t),
            n = a._i(t)
          return 400 < i && 120 < n
        })).indexOf("cpro_prev") > 0 && (t = t.slice(0, t.indexOf('?'))), t
      }
    }, {
      key: 'liu',
      encode: !0,
  ...
  t.exports = {
    ...
    Yn: function (t, i) {
      for (var n in this.paramsList = [], i) {if (n && i.hasOwnProperty(n) && this.Kn[n]) {
        var e = this.Kn[n],
          r = {}
        try {
  ...
  t.exports = {
    ...
    ne: function (t) {
      var i = t.response.placement.userdefine || '';
        var n = t.response.placement.encode_userdefine || ''
      ...
      var u = t.styleOpenApi.tn || '';
        var h = parseInt(t.styleOpenApi.xuanting || 0, 10)
      return u.indexOf("mobile") >= 0 && h > 0 ? 'mobile.float' : u.indexOf("mobile") >= 0 ? 'mobile.inlayFix' : h > 0 ? 'dynamicFloat' : u && u.length > 0 && u.indexOf('_xuanfu') < 0 && u.indexOf('float') < 0 ? 'inlayFix' : ''
    },
    ee: function (t) {
    ...
    re: function (t) {
      var i = t.placement;
        var n = i.container;
        var e = i.fillstyle
      return !(n.anchoredType !== 3 || !n.slide || e.btnStyleId !== 9)
    },
    oe: function (t) {
      var i = t.placement;
        var n = i.basic;
        var e = i.container;
        var r = e.floated
      return n.rspFormat === 1 && n.flowType === 1 && e.anchoredType === 1 && (!r || (r.trigger === 1 || !this.fe(r)))
    },
    fe: function (t) {
    ...
    ae: function (t) {
      var i = t.placement;
        ...
        var e = i.container;
        var r = e.floated
      return !(n.rspFormat !== 1 || n.flowType !== 1 || e.anchoredType !== 1 || !r || r.trigger !== 8)
    },
    se: function (t) {
      var i = t.placement;
        var n = i.basic;
        var e = i.container
      return n.rspFormat === 3 && n.flowType === 1 && e.occurrence === 8 && e.anchoredType === 11
    },
    ce: function (t) {
      var i = t.placement;
        var n = i.basic;
        var e = i.container
      return n.rspFormat === 1 && n.flowType === 2 && e.anchoredType === 1
    },
    ue: function (t) {
      var i = t.placement;
        var n = i.basic;
        var e = i.container
      return n.rspFormat === 1 && n.flowType === 2 && (e.anchoredType === 3 || e.anchoredType === 11)
    },
    he: function (t) {
      var i = t.placement;
        var n = i.basic;
        var e = i.container
      return n.rspFormat === 3 && n.flowType === 2 && e.occurrence === 8 && e.anchoredType === 11
    }
  }
}, function (t, i, n) {
  try {
    ...
    var e = v && v.stack ? v.stack : v;
      var r = ['//eclick.baidu.com/se.jpg?', 'type=fatalError', 'version=newDup', 'mes=' + encodeURIComponent(e)].join('&');
    (new Image()).src = r
  }
  ...
  t.exports = {
    paramsList: [{
      ...
      value: function () {
        var t = [];
          var i = this.Vn.styleOpenApi
        for (var n in '-1' === this.Vn.pcwd && (i.cpro_ftpc = 'true'), i) {if (n && "undefined" != typeof i[n] && i.hasOwnProperty(n)) {
          var e = n
  ...
  t.exports = {
    ...
    Ae: function (t, i) {
      return (i %= 64) === 32 ? [t[1], t[0]] : i < 32 ? [t[0] << i | t[1] >>> 32 - i, t[1] << i | t[0] >>> 32 - i] : (i -= 32, [t[1] << i | t[0] >>> 32 - i, t[0] << i | t[1] >>> 32 - i])
    },
    ke: function (t, i) {
      return (i %= 64) === 0 ? t : i < 32 ? [t[0] << i | t[1] >>> 32 - i, t[1] << i] : [t[1] << i - 32, 0]
    },
    De: function (t, i) {
    ...
    de: function () {
      try {
        for (var t = '', i = a.paramsList, n = 0; n < i.length; n++) {if ("ltu" === i[n].key) {
          t = c.C(a, i[n].value)()
          break
        }}
        return this.le({
  ...
  t.exports = {
    ...
    Jn: function (t) {
      (t = t || document.domain).indexOf("www.") === 0 && (t = t.substr(4)), '.' === t.charAt(t.length - 1) && (t = t.substring(0, t.length - 1))
    ...
    paramsList: [{
      ...
      value: function () {
        var t = (new Date()).getTime();
          var i = a.DUP_4_SF ? a : this.Ue;
          var n = i[e.At]
        return (!n || 'number' !== typeof n || t - n >= 24e4) && (n = i[e.At] = t), n
      }
    }, {
      key: 'cop',
      encode: !0,
  ...
  t.exports = {
      ...
      if ('success' !== (t.html || 'success')) {
        ...
        if (i) {
          var n = i.response;
            ...
            var o = n.order_deliv;
            var a = e.deliv_des
          if (a = a._html || {}, parseInt(e.deliv_id, 10) === 0 && (parseInt(o.deliv_id, 10) !== 0 || parseInt(r.deliv_id, 10) !== 0) && n.placement.complement_type === 7) return this.Te(i)
          if ('rich' === a.type) {
    ...
    Te: function (t) {
      var i = t.containerId;
        ...
        var e = document.getElementById(i + "_left");
        var r = document.getElementById(i + '_right')
  ...
  t.exports = {
    ...
    Fe: function (t, i) {
      var n = t
      n.indexOf(".") > 0 && (n = n.replace('.', '/')), n = c.Dt + n + '.js', y.je(i.id, n, v.C(this, this.Ne, t, i))
    },
    Ne: function (t, i) {
      try {
        var n = this.Me(t)
    ...
    Le: function (t, i, n) {
      n && (n.render(i), this.He(i), t && t.indexOf("mobile") > -1 && (_.regisetViewWatch(i), window.postMessage && i.isUnion || e.Jt(i.response.queryid)), this.We(i))
    },
    He: function (i) {
      var t = l.g(i.containerId);
        var n = t && t.querySelector && t.querySelector('iframe')
    ...
    Be: function () {
      arguments.length > 0 && 'auto' === arguments[0] && w.Re.apply(w, arguments)
    },
    We: function (t) {
      var i = l.g(t.containerId); (t.paramObj.dis ? t.paramObj.ltu : window.location.href).indexOf(c.kt) > - 1 && m.Ri(i, t.id)
    }
  }
}, function (t, i, n) {
  var o = n(3);
  ...
  t.exports = {
    ...
    Ge: function (t) {
      try {
        for (var i = 0, n = t + '_' + i; o.Ct(n) && o.Ct(n)[0] !== 0;) {
          var e = o.Ct(n)
          o.Et(e, a.ut), n = t + '_' + ++i
        }
      } catch (r) {}
  ...
  t.exports = {
    Ee: function () {
      ...
      if (window.cproArray = null, n) {for (var e = 0, r = n.length; e < r; e++) t = c.Pt({
        slotId: n[e].id,
        productLine: "union",
        isAsync: !0
      }), c.Tt(t, !0)}
      var o = window.cpro_mobile_slot
      if (window.cpro_mobile_slot = null, o) {for (e = 0, r = o.length; e < r; e++) {
        var a = o[e]
        for (var s in (t = c.Pt({
          slotId: a.id,
          productLine: "union",
      ...
      for (var t, i = 0, n = this.delieveryObjArray.length; i < n; i++) {
        ...
        if (e.hasOwnProperty('id')) {
          var r = e.hasOwnProperty('isAsync') && e.isAsync || e.hasOwnProperty('async') && e.async;
            var o = e.hasOwnProperty('coa') && e.coa
          t = a.Pt({
            slotId: e.id,
            productLine: 'adcodex',
            isAsync: r,
  ...
  t.exports = {
    Ee: function () {
      try {
        if (!(u.expId || o.baiduboxapp || window.___baidu_union_ && window.___baidu_union_.expId)) {if (u.expId = "110011", 0 === f.Dn("slotParam", "dis")) {
          var t = this.Ke()
    ...
    Ze: function (t) {
      var i = t && t.children
      if (i && i.length > 1 && t.scrollHeight > window.screen.height) {
        var n = i.length
  ...
  t.exports = {
    ...
    er: function (t, i, n) {
      n = arguments.length === 3 ? (i = i, n) : i = t
      var e = s[i]
  ...
  t.exports = {
    ...
    ur: function (t, i) {
      i.complementType === 0 && (t.style.width = i.width + 'px', t.style.height = i.height + 'px', t.style.display = 'inline-block')
    },
    render: function (t) {
      c.Bt(t.id, a.ct)
      ...
      var n = t.containerInfo.slide;
        var e = n && !v.f(n) && p
      if (e && (l.hr(t), this.rr(t)), this.ar(t)) {if (d.Fi(t), f.renderRichMaterial(t)) p && setTimeout(function() {
        l.or("adloaded", t.id)
      }, 800)
      else {
  ...
  t.exports = {
    ...
    vr: function (t) {
      if (!_[t]) {
        _[t] = !0
        var i = p.Ut(t);
          var n = i.containerInfo;
          var e = n.width;
          var r = n.height;
          var o = n.slide;
          var a = o.slideWidth;
          var s = o.slideHeight;
          var c = 1e3 * parseInt(o.extendTime, 10);
          var u = parseInt(o.slideMode, 10);
          var h = parseInt(o.direction, 10);
          var f = v.g(i.containerId);
          var d = f.getElementsByTagName('iframe')[0]
        if (h === 1 || h === 2 ? (d.setAttribute('height', s), d.style.height = s + 'px') : h !== 3 && h !== 4 || (d.setAttribute('width', a), d.style.width = a + 'px'), u === 2 && h === 2 || u === 2 && h === 4) {switch (h) {
          case 2:
    ...
    pr: function (t) {
      if (_[t]) {
        ...
        var i = p.Ut(t);
          var n = i.containerInfo.width;
          var e = i.containerInfo.height;
          var r = v.g(i.containerId);
          var o = r.getElementsByTagName('iframe')[0]
        for (var a in r.style.position = '', r.style.width = '', r.style.height = '', r.style.top = '', r.style.left = '', o.style.position = '', o.style.display = '', o.style.top = '', o.style.left = '', o.style.right = '', o.style.width = '', o.style.height = '', o.setAttribute('height', e), o.setAttribute('width', n), c) for (var s in c[a]) s === t && (c[a][s].isExpand = !1)
      }
    },
    hr: function (t) {
      t = p.Ut(t.slotId)
    ...
    or: function (t, i) {
      var n; var e = p.Ut(i).containerInfo.slide
      e && (n = e.trigger)
      var r;
  ...
  t.exports = {
    ...
    sr: function (t) {
      ...
      if (!n) return i
      var e = n.placement
      if ((s.oe(n) || s.ae(n)) && (i = c), e && e.fillstyle) for (var r = n.placement.fillstyle.elements || [], o = 0, a = r.length; o < a; o++) if (r[o] === 5) return u
      return i
    }
  }
}, function (t, i, n) {
  ...
  t.exports = {
    ...
    render: function (t) {
      ...
      if (h.Fi(t), !d.renderRichMaterial(t)) {
        ...
        if (t.width = n.width, t.height = n.height, n.sizeType === 2 || n.sizeType === 5) {
  ...
  t.exports = {
    ...
    Or: function (t, i) {
      var n = !1;
        var e = t.containerInfo.location;
        var r = t.styleOpenApi;
        var o = r.apType === 2
      if (e === 2 && !o) return !1;
      (i.sizeType !== 1 || r.rsi0 || r.rsi1 || r.cpro_w || r.cpro_h) && (n = i.width / i.height > 3.4)
      return n
    },
    Er: function (t) {
      var i = t.containerInfo;
        var n = t.response.placement.fillstyle || {};
        var e = parseFloat(n.opacity || .9);
        var r = n.backgroundColor || '#000'
    ...
    Br: function (t) {
      var i = '';
        ...
        var e = "0";
        var r = 0
      return r = t.locationType === 2 ? (i = '0 0 40px 40px', e = t.height, n = t.floatingState === this.kr ? this.Tr : this.Pr, this.Ur) : (i = '40px 40px 0 0', e = -20, n = t.floatingState === this.kr ? this.Pr : this.Tr, this.Cr), {
        domId: t.containerId,
        borderRadius: i,
        top: e,
        btnTag: n,
    ...
    ur: function (t, i) {
      var n = 0;
        var e = 'absolute'
      a.Ui() ? (e = 'fixed', i.floatingState !== this.kr && 'ontouchend' in document && i.height > 0 && (n = -1 * (i.height + 20))) : n = a.Ai(window) + a._i(window) - i.height
      var r = i.locationType === 2 ? 'top' : 'bottom';
        var o = i.locationType === 2 ? 'border-bottom' : 'border-top'
    ...
    zr: function (t, i, n, e, r) {
      ...
      (o < -10 && !this[e] && r === this.Dr || o > 10 && !this[e] && r === this.xr) && (this[e] = !0, this.Fr(e, i, n))
    },
    Rr: function (t, i) {
      return t.styleOpenApi && t.styleOpenApi.floatingState ? t.styleOpenApi.floatingState : i === 2 ? this.Dr : this.kr
    },
    Nr: function (t, i) {
      if (t.sizeType === 2) {
  ...
  t.exports = {
    ...
    $r: function () {
      ...
      if (t) {
        ...
        if (i && i.length !== 0) {for (var n in this.Vr) {
          var e = this.Vr[n]
    ...
    no: function (t, i) {
      ...
      if (n && n.length > 0 && e.test(i) && this.eo(n, i) && this.ro(n, i)) {
    ...
    eo: function (t, i) {
      var n = i.indexOf(t);
        var e = n - 4;
        var r = n + t.length;
        var o = "</a>" === i.substr(e, 4);
        var a = '<a ' === i.substr(r, 3)
      return !o && !a
    },
    ro: function (t, i) {
  ...
  var e = n(2);
    var r = n(15);
    var o = String.fromCharCode(Math.floor(26 * Math.random()) + 97);
    var a = String.fromCharCode(Math.floor(26 * Math.random()) + 97)
